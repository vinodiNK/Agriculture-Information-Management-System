...
<div style="background-color: black; height:8px;"></div>    <!--nav bar ekata uda orange color bar eka-->
    ...
    <nav id="sec-nav" class="navbar sec-nav sticky-top navbar-expand-sm justify-content-center">
        ...
        <ul class="navbar-nav text-uppercase font-weight-bolder">
            <li class="nav-item">
                <a class="nav-link navmenu" href="../newlogin/user2.php" style="color:rgba(11, 87, 4)"> Admin Home</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link navmenu" href="../a/cal.php"style="color:rgba(11, 87, 4)">
Manage Fertilizer Details</a>
            </li>
            <li class="nav-item">
